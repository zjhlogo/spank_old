...
class ActionQuadraticMove : public IActionBase
{
public:
	DECLARE_RTTI(ActionQuadraticMove, IActionBase);
public:
	ActionQuadraticMove(uint eType,const Vector3& posStart, const Vector3& posEnd, float time);
	virtual void Reset() ;
